...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swim techniques and train for competitions",
    ...
    "Drama Club": {
        "description": "Act in plays, practice improvisation, and develop stagecraft",
    ...
    "Robotics Club": {
        ...
        "max_participants": 14,
        "participants": ["sara@mergington.edu", "jordan@mergington.edu"]
    },
    "Debate Team": {
